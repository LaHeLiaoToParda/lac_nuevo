								...
								<ul id="menu-content2" class="menu-content collapse show">
									...
									<li><a href="ServletListado?operacion=genero&genero=MUJER&categoria=SOLO">Mujer</a>
										<ul class="sub-menu collapse show" id="clothing">
											<li><a href="ServletListado?operacion=genero&genero=MUJER&categoria=MANGA CORTA">Camiseta Maga Corta</a></li>
											<li><a href="ServletListado?operacion=genero&genero=MUJER&categoria=TIRANTES">Camiseta Tirantes</a></li>
											<li><a href="ServletListado?operacion=genero&genero=MUJER&categoria=MANGA LARGA">Camiseta Manga Larga</a></li>
										</ul></li>
